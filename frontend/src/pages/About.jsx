...
const About = () => (
  <main>
    ...
    {/* Intro */}
    <section className="max-w-[1400px] mx-auto px-5 lg:px-10 py-20 grid lg:grid-cols-2 gap-16 items-center">
      <div className="img-reveal rounded-[32px] overflow-hidden">
        <img src="https://images.unsplash.com/photo-1610832958506-aa56368176cf?w=1000" alt="organic" className="w-full h-[540px] object-cover" />
      </div>
      <div>
        <div className="inline-flex items-center gap-2 text-xs uppercase tracking-[0.3em] text-[#4a7c2a] font-semibold mb-4"><Leaf size={14} /> Since 2012</div>
    ...
    <section className="bg-[#f5f0e6]">
      <div className="max-w-[1400px] mx-auto px-5 lg:px-10 py-20 grid md:grid-cols-2 gap-8">
        <div className="bg-white rounded-[32px] p-10 border border-[#eae5d8] relative overflow-hidden group">
          <div className="absolute -bottom-10 -right-10 w-40 h-40 rounded-full bg-[#4a7c2a]/10 group-hover:bg-[#4a7c2a]/20 transition" />
          ...
          <ul className="mt-6 space-y-4 text-[#3a4530]">
            <li className="flex gap-3"><Sprout size={18} className="text-[#4a7c2a] mt-0.5 flex-shrink-0" /> A world where organic and sustainable is the norm and chemical agriculture is non-existent.</li>
            <li className="flex gap-3"><Sprout size={18} className="text-[#4a7c2a] mt-0.5 flex-shrink-0" /> A world that says no to poisons — for your family, the farmers, and the Earth.</li>
            <li className="flex gap-3"><Sprout size={18} className="text-[#4a7c2a] mt-0.5 flex-shrink-0" /> We started with just a few farmers and products. Today we offer 300+ products sourced from 13 different states.</li>
          </ul>
        </div>
        <div className="bg-[#1f2a1a] text-white rounded-[32px] p-10 relative overflow-hidden group">
          <div className="absolute -top-10 -left-10 w-40 h-40 rounded-full bg-[#a3c86d]/20 blur-2xl" />
    ...
    <section className="bg-gradient-to-br from-[#f5f0e6] to-[#faf7f2] relative overflow-hidden">
      ...
      <div className="relative max-w-[1400px] mx-auto px-5 lg:px-10 py-20">
        <div className="text-center max-w-2xl mx-auto mb-16">
          <div className="inline-flex items-center gap-2 text-xs uppercase tracking-[0.3em] text-[#4a7c2a] font-semibold mb-4"><Users size={14} /> Our History</div>
        ...
        <div className="relative">
          <div className="absolute left-1/2 top-0 bottom-0 w-0.5 bg-[#4a7c2a]/30 hidden md:block" />
          <div className="space-y-12">
            {HISTORY.map((h, i) => (
              <div key={i} className={`md:grid md:grid-cols-2 md:gap-12 items-center ${i % 2 === 1 ? "md:direction-rtl" : ""}`}>
                ...
                <div className={`relative pl-8 md:pl-12 border-l-2 md:border-l-0 border-[#4a7c2a]/30 ${i % 2 === 1 ? "md:order-1 md:pr-12 md:pl-0 md:border-r-2 md:text-right" : ""}`}>
                  <span className="absolute -left-2 md:left-auto md:-right-2 top-0 w-4 h-4 rounded-full bg-[#2e7d32] ring-4 ring-[#f5f0e6]" style={{left: i % 2 === 1 ? "auto" : "-8px", right: i % 2 === 1 ? "-8px" : "auto"}} />
