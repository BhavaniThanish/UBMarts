  ...
  return (
    <main>
      ...
      <section className="max-w-[1400px] mx-auto px-5 lg:px-10 py-20">
        <div className="w-100 max-w-5xl mx-auto rounded-3xl overflow-hidden shadow-2xl bg-black">
          <video className="w-100 h-auto max-h-[80vh] object-cover" controls preload="metadata">
